...
#
# Generated by export_simulation on Mon Dec 19 16:26:54 +0900 2022
#
################################################################################
...
'-reset_run' switch to the './z7_lite.sh' script.

./z7_lite.sh -reset_run
...
./z7_lite.sh -noclean_files

For more information on the script, please type './z7_lite.sh -help'.
